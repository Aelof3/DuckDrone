...
export default class DuckDroneLevel8 extends DuckDroneLevel{
    constructor( data ){
        super( data );

        this.color = 'hsl(210,100%,50%)';

        this.pos = {x:150,y:0,z:-450};
    ...
    onCreate( ){
        ...
        this.rotaterV.add( this.levelObjects[2].body );
        this.rotaterV.add( this.levelObjects[3].body );
